...
const THREAD_HEX_BY_CODE = {
  ...
  "1662": "#4e342e", "1663": "#795548", "1666": "#ccd5ae", "1668": "#3a6351",
  "1670": "#d4b45f", "1676": "#1c2d5a", "1678": "#ff4f00", "1680": "#4b1f6f",
  "1681": "#a50034", "1682": "#6d4c41", "1686": "#d9d9d6", "1690": "#2ec4b6",
  "1694": "#008c95", "1702": "#00a676", "1703": "#2d6a4f", "1704": "#003f2d",
  "1705": "#4a7c59", "1710": "#c964cf", "1711": "#b38bfa", "1718": "#a7c7e7",
  "1722": "#4c1d95", "1723": "#7f5539", "1728": "#b08968", "1729": "#5d4037",
  ...
  "1800": "#000000", "1802": "#636e72", "1803": "#b2bec3", "1804": "#dfe6e9",
  "1816": "#ffb3c7", "1820": "#ff9a6c", "1822": "#fff3b0", "1826": "#fcd299",
  "1827": "#00a3e0", "1828": "#b6e0ff", "1830": "#1e90ff", "1832": "#7c3aed",
  "1837": "#ff5e00", "1838": "#c41e3a", "1840": "#cfd8dc", "1841": "#b0bec5",
  "1842": "#003a8f", "1845": "#b6f2c6", "1847": "#00c7b1", "1848": "#66bb6a",
  "1849": "#00543c", "1851": "#1b5e20", "1852": "#0096c7", "1855": "#c99700",
  "1856": "#a84300", "1860": "#a1887f", "1861": "#f6e27a", "1863": "#a3b18a",
  "1868": "#00a86b", "1872": "#8d6e63", "1879": "#004d3f", "1880": "#6f2da8",
  "1883": "#f6ff00", "1885": "#b58300", "1887": "#5d3fd3", "1890": "#48cae4",
  "1891": "#004f4f", "1892": "#00b5cc", "1898": "#cc3d00", "1901": "#aacc00",
  "1902": "#0f3d1f", "1903": "#6b9080", "1904": "#4f772d", "1907": "#ff4f58",
  "1908": "#ff2d2d", "1910": "#ff99cc", "1919": "#a64d79", "1921": "#ff5c8a",
  "1922": "#3c1361", "1923": "#ffc72c", "1924": "#ffd100", "1925": "#ff3eb5",
  "1926": "#c4a484", "1928": "#a1887f", "1929": "#5d4037", "1930": "#1d2f6f",
  "1932": "#aee7ff", "1933": "#7b68ee", "1936": "#8d6e63", "1937": "#ff6a00",
  "1938": "#6d4c41", "1939": "#d4a373", "1941": "#b784a7", "1943": "#00509e",
  "1944": "#263238", "1946": "#ff66cc", "1948": "#ff9dbb", "1949": "#d4af37",
  "1951": "#ffcd38", "1952": "#ff7f5f", "1954": "#ff2f6d", "1957": "#5d4037",
  "1958": "#4d0f1c", "1960": "#6c8ebf", "1961": "#4f6d7a", "1964": "#3e5c76",
  "1965": "#ff6a13", "1969": "#4f6228", "1971": "#ffd966", "1972": "#ffb81c",
  "1974": "#7a1f2b", "1976": "#003f87", "1985": "#007a53", "1989": "#80b918",
  "1991": "#006d6f", "1993": "#ff3d6e", "1997": "#6a4c93", "1999": "#3f0a12",
};

/** Prefer a 4-digit code that exists in THREAD_HEX_BY_CODE (avoids matching years/order ids first). */
function threadCodeForSwatch(name) {
  const str = String(name || "");
  const codes = [...str.matchAll(/\b(\d{4})\b/g)].map((m) => m[1]);
  for (const c of codes) {
    if (THREAD_HEX_BY_CODE[c]) return c;
  }
  return codes[0] || null;
}

function colorFromName(name) {
  const code = threadCodeForSwatch(name);
  if (code && THREAD_HEX_BY_CODE[code]) return THREAD_HEX_BY_CODE[code];
