...
import { THREAD_HEX_BY_CODE, madeiraThreadLine } from "./madeiraThreadColors";
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {(threadConflictSnapshot.conflicts || []).map((c) => {
                ...
                const threadCode = threadCodeForSwatch(c.color);
                const threadLine = madeiraThreadLine(threadCode) || "Polyneon";
